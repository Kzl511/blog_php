            ...
            <div class="card">
              ...
              <?php 
                ...
                if (empty($_POST['search'])) {
                  ...
                  $stmt = $pdo->prepare("SELECT * FROM users WHERE name LIKE '%$searchKey%' LIMIT $offset, $numOfRecs");
                  $stmt->execute();
                  $result = $stmt->fetchAll();
                }
              ?>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="delete-container">
                            <a href="user_delete.php?id=<?php echo $value['id'] ?>" type="button" onclick="return confirm('Are you sure you want to delete this user?')" class="btn btn-danger">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
